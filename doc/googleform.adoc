...
++++
  ...
  <script>
      ...
      document.getElementById("custom_form").addEventListener("submit", function() {
          ...
          form_iframe.src = encodeURI(`https://docs.google.com/forms/u/0/d/e/1FAIpQLSd8jktXNPJ8HiHzZRWLIsl5uICauyyRnZu61SwT7PhMqyk1XQ/formResponse?emailAddress=${get_textbox_value("emailAddress")}&entry.1664715574=${get_textarea_value("entry.1664715574")}&entry.593226274=${location.pathname}.&submit=Submit`);
